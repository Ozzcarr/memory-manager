...
void capture_stdout(char *buffer, size_t size,
                    void (*func)(Node **, Node *, Node *), Node **head,
...
void test_list_display() {
    ...
    capture_stdout(buffer, sizeof(buffer),
                   (void (*)(Node **, Node *, Node *))list_display_range, &head,
                   NULL, NULL);
...
int main(int argc, char *argv[]) {
    ...
    if (argc < 2) {
        ...
        printf(
            " 3. test_list_insert_after - Test list insert after a given "
            "node\n");
        printf(
            " 4. test_list_insert_before - Test list insert before a given "
            "node\n");
        printf(" 5. test_list_delete - Test delete operation\n");
        printf(" 6. test_list_search - Test search for a particular node\n");
        printf(
            " 7. test_list_display - Test the display functionality. Requires "
        ...
        printf(
            " 11. test_list_insert_after_loop - Test multiple insertions after "
            "a given node\n");
